-- ─────────────────────────────────────────────────────────────────────────────
-- GlossIO — Create missing tables (safe to re-run)
-- Existing tables: detailers, appointments
-- Missing: profiles, services, work_photos, clients, business_hours,
--          notification_settings, availability_settings, availability_blocks,
--          verification_codes
-- ─────────────────────────────────────────────────────────────────────────────
...
-- Profiles: public read (for booking pages) + owner write
...
-- Services: public read active, owner all
...
-- ─── Seed Virgilio's profile row ─────────────────────────────────────────────
-- Create a profiles row for the existing user from auth.users metadata
